...
class Encoder_M(nn.Module):
    def __init__(self):
        ...
        self.conv1_m = nn.Conv2d(1,
                                 64,
                                 kernel_size=7,
                                 stride=2,
                                 padding=3,
                                 bias=False)
        self.conv1_o = nn.Conv2d(1,
                                 64,
                                 kernel_size=7,
                                 stride=2,
                                 padding=3,
...
class STM(nn.Module):
    ...
    def memorize(self, frame, masks, num_objects):
        ...
        (frame, masks), pad = pad_divide_by([frame, masks], 16,
    ...
    def Soft_aggregation(self, ps, K):
        ...
        em = ToCuda(torch.zeros(1, K, H, W), self.gpu_id)
