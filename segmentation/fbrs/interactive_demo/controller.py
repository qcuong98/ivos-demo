...
class InteractiveController:
    ...
    def set_image(self, image):
        ...
        if self.update_image_callback is not None:
    ...
    def reset_last_object(self, update_image=True):
        ...
        self.clicker.reset_clicks()
        self.reset_predictor()
        if update_image and self.update_image_callback is not None:
            self.update_image_callback()
    ...
    def get_result_mask(self):
        ...
        results_mask_for_vis[self.current_object_prob > self.prob_thresh] = 1
        # print(results_mask_for_vis.shape)
        # print(results_mask_for_vis.max(), results_mask_for_vis.min())
        return results_mask_for_vis
